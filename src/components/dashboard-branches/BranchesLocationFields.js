...
function BranchesLocationFields({ control, errors }) {
  ...
  return (
    <>
      ...
      >
        {availableLocation.province.map((item) => {
          return (
      ...
      >
        {availableLocation.cell.map((item, index) => {
          return (
            <MenuItem key={item.value} value={item.value}>
              {item.value}
            </MenuItem>
...
export default BranchesLocationFields;
