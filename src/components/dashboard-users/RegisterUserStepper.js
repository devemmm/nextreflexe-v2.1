...
import RegisterUserStep1 from './RegisterUserStep1';
import RegisterUserStep2 from './RegisterUserStep2';
  ...
  return (
    <>
      ...
      >
        ...
        >
          {activeStep === 0 && (
            <RegisterUserStep1 control={control} errors={errors} />
          )}
          {activeStep === 1 && (
            <RegisterUserStep2 control={control} errors={errors} />
          )}
        </Stack>
        <Stack
...
export default RegisterUserStepper;
